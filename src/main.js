...
import {
  traerDataMap2, filtroHuevo, filtroDebilidadTipo, buscarPorNombre, AsDes, evolutions, filterInfEvoAndCandy, filtroFusionado, filtroGeneralDebilidad, 
} from './data.js';
...
btnFiltrar.addEventListener('click', () => {
  ...
  console.log('Info Tipo:', checkTipo);
  ...
  console.log('Info Debilidades:',selectDebilidad);
